...
const AdminVacancyEditPage: React.FC = () => {
  ...
  const inputFields: Array<{ key: "title" | "location"; label: string }> = [
    { key: "title", label: t("vacancy.title") },
    { key: "location", label: t("vacancy.location") },
  ];
  ...
  const textareaFields: Array<{
    ...
    { key: "description", label: t("vacancy.description"), rows: 4 },
    { key: "requirements", label: t("vacancy.requirements"), rows: 3 },
  ];
